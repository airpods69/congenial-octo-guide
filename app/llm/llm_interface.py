...
llm = llm_factory.get_llm("llamacpp","/mnt/storage/RandomCS/text-generation-webui/models/tinyllama-1.1b-1t-Q4gguf/tinyllama-1.1b-intermediate-step-480k-1t.Q4_K_S.gguf", gpu_layers=20, context_length=4000)
